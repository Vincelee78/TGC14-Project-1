...
document.querySelector('#mbsAttraction').addEventListener('click', async function(){
  ...
  marker.bindPopup(`<center><h4>Marina Bay Sands</h4>Marina Bay Sands® is a destination for those who appreciate luxury. An integrated resort notable for transforming Singapore’s city skyline, it comprises three 55-storey towers of extravagant hotel rooms and luxury suites with personal butler services. In addition, its architecture is made complete with the Sands SkyPark® which crowns the three towers. </center></br><center><a href="https://www.marinabaysands.com/" target="_blank"><img src="mbs-info-image.jpg" height="100px" width="200px"/></a></center>`, {
    maxHeight: "fit",
    maxWidth: "fit"
  })
  marker.openPopup()
...
document.querySelector('#universalAttraction').addEventListener('click', async function(){
  let universalStudiosIcon = L.icon({
    iconUrl: 'universal-studios-singapore-marker.png',
    iconSize: [100, 50],
