...
| Adding or removing DOM elements to the display (map, DOM tree, game screen) based on user's actions |Added **Search feature**
 **Toggle hawker centres**
 **Taxi coordinates**, **All hotels feature**, **Top 3 attractions feature**, **Remove search results and remove eateries feature**, **Slide information bar in and out feature** | 20 |
