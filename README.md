...
| Adding or removing DOM elements to the display (map, DOM tree, game screen) based on user's actions |Added **1.**Search feature, **2.**Toggle hawker centres, taxi coordinates, all hotels feature, **3)**Top 3 attractions feature, **4)**Remove search results and remove eateries feature, - Slide information bar in and out feature | 20 |
