...
| 4 | Under the 'Search Singapore!' textbox , user inputs keywords 'attractions' and click on the magnifying glass search icon. The search results container will appear 30 search results with 'Universal Studios Singapore' as its first result. Clicking on 'Universal Studios Singapore' will bring to user to Universal Studios Singapore location and the popup box with its details | Pass |
| 5 | Clicking on 'Remove Searches' in the infotab removes all the search results and the respective markers. Clicking on the arrow down icon in the top extreme right of the Navtab bar removes the search results with the markers still intact | Pass |
| 6 | Clicking on the 'toggle the info tab' button on the bottom right of the screen slides the info tab out of the screen and clicking it again slides it in | Pass |
| 7 | Clicking on the checkbox of the 'Taxi locations' in the Navtab icon on the top right creates cluster markers of the taxi locations. Clicking on the taxi icon opens a popup with the address of the current taxi. Clicking on the checkbox again removes the cluster markers | Pass |
| 8 | Clicking the checkbox of the 'Hawker Centers' in the Navtab icon on the top right creates cluster markers of the hawker centers. Clicking on the utensils marker icon shows a popup with the address of the current hawker center and its details. Clicking on the checkbox again removes the cluster markers | Pass |
| 9 | Clicking on the checkbox of the 'Hotels' in the Navtab icon on the top right creates cluster markers of all the hotels. Clicking on the hotel marker icon shows a popup with the address of the current hotel and its details. Unchecking the hotel checkbox again removes the cluster markers | Pass |
...
3. [Iphone 7](https://res.cloudinary.com/dtrwtlldr/image/upload/v1639968831/IMG_6075_ggk06l.png)
